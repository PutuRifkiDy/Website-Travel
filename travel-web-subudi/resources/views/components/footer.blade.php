<div class="md:px-20 px-6 flex flex-col">
    <div class="flex md:flex-row flex-col justify-between mb-20 w-full">
        <div class="flex flex-col gap-5 md:mb-0 mb-10">
            ...
            <div class="flex flex-row gap-5 items-center">
                ...
                <a href=""><img src="{{asset('assets/icons/icon-twitter.svg')}}" alt=""></a>
                <a href=""><img src="{{asset('assets/icons/icon-instagram.svg')}}" alt=""></a>
                <a href=""><img src="{{asset('assets/icons/icon-linkedin.svg')}}" alt=""></a>
                <a href=""><img src="{{asset('assets/icons/icon-youtube.svg')}}" alt=""></a>
            </div>
        </div>

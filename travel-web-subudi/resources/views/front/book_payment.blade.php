        ...
        <form action="{{route('front.book_payment_store', $packageBooking->id)}}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-8">
            ...
            <div class="flex flex-col gap-3 px-4 ">
                ...
                <div class="bg-white p-4 rounded-[26px] flex items-center gap-3">
                    <div class="w-[72px] h-[72px] flex shrink-0 rounded-xl overflow-hidden">
                        <img src="{{Storage::url($packageBooking->tour->thumbnail)}}" class="w-full h-full object-cover object-center"
                            alt="thumbnail">
                    </div>
            ...
            <div class="flex flex-col gap-3 px-4 ">
                ...
                <div class="bg-white p-[16px_24px] rounded-[26px] flex flex-col gap-4">
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-[35px] h-[25px] flex shrink-0 overflow-hidden">
                                <img src="{{Storage::url($packageBooking->bank->logo)}}" class="w-full h-full object-contain object-center"
                                    alt="logo">
                            </div>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                                <img src="{{asset('assets/icons/bank.svg')}}" class="w-full h-full object-contain object-center"
                                    alt="logo">
                            </div>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center gap-2">
                            <div class="w-6 h-6 flex shrink-0 overflow-hidden">
                                <img src="{{asset('assets/icons/moneys.svg')}}" class="w-full h-full object-contain object-center"
                                    alt="logo">
                            </div>
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center justify-between">
                            <span id="total-payment" class="font-semibold text-lg tracking-[0.6px] leading-[26px]"
                                data-value="2500000">{{number_format($packageBooking->total_amount, 0, ',', '.')}}</span>
                            <button type="button"
                                class="font-semibold text-sm tracking-035 leading-[22px] text-blue w-fit ml-auto"
            ...
            <div class="flex flex-col gap-3 px-4 ">
                ...
                <div
                    ...
                    <img src="{{asset('assets/backgrounds/reward-right.png')}}" class="absolute w-[73px] h-[53px] top-0 right-0"
                        alt="rewards">
                </div>
            </div>
            <div

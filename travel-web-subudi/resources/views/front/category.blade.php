...
<section id="content" class="md:px-20 px-6 w-full mx-auto min-h-screen flex flex-col gap-8 mt-24 pb-24">
    <nav class="mt-8 w-full flex items-center justify-between">
        <a href="{{ route('front.index') }}">
            <img src="{{ asset('assets/icons/back.png') }}" alt="back" class="border border-slate-300 rounded-full">
        </a>
    ...
    <div class="grid md:grid-cols-3 grid-cols-1 gap-10">
        @forelse($category->tours as $tour)
            <div class="rounded-2xl p-5 card md:w-[350px] w-full">

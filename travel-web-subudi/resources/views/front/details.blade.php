...
@section('content')
    <section id="content" class="md:px-24 px-6 w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
            ...
            <div class="grid grid-cols-4 gap-4 w-fit mx-auto">
                ...
                @forelse($latestPhotos as $photo)
                    <a href="{{ Storage::url($photo->photo) }}"
                        ...
                        <img src="{{ Storage::url($photo->photo) }}" class="w-full h-full object-cover object-center"
                            alt="thumbnail">
                    </a>
        ...
        <div
            ...
            <a href="https://wa.me/62881038194017?text=Halo,%20saya%20tertarik%20dengan%20produk%20Anda" target="_blank"
                class="p-[16px_24px] rounded-xl bg-blue w-fit text-white hover:bg-[#06C755] transition-all duration-300">
                Chat
                Now
            </a>
        </div>

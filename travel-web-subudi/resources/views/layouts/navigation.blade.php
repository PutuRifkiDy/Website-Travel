{{-- <nav x-data="{ open: false }" class="bg-white border-b border-gray-100 font-poppins">
            ...
            <div>
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('front.index') }}"
                        class="text-pink-gradient text-[32px] md:text-[39.4px] leading-[31.56px] font-bold font-poppins">
                        SubudiTour
                    </a>
                </div>
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                @auth<div class="font-medium text-base text-gray-800">{{ Auth::user()->name }}</div>@endauth
                @auth<div class="font-medium text-sm text-gray-500">{{ Auth::user()->email }}</div>@endauth
            </div>
